                    ...
                    <div class="row">
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
												if(!mysqli_num_rows($query_res) > 0 )
														{
															echo '<td colspan="6"><center>Você ainda não tem pedidos feitos. </center></td>';
														}
													else
														{			      
							...
							?>
												<tr>	
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="price">MZN<?php echo $row['price']; ?></td>
														   ...
														   <?php 
																			...
																			{
																			?>
																			<button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Despacho</button>
																		   <?php 
																			  }
