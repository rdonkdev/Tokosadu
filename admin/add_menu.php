...
<head>
    ...
    <link rel="icon" type="images/manager.png" sizes="16x16" href="images/favicon.png">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                                ...
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" class="form-control" placeholder="MZN">
                                                   </div>
                                            </div>
                                        ...
                                        <div class="row">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Selecionar Restaurante</label>
					...
					<footer class="footer"> © 2023 - Tocossado All Rights Reserved: <a href="https://instagram.com/stackdevz/" >StackDev</a> </footer>
                </div>               
            </div>
        </div>    
    </div>
