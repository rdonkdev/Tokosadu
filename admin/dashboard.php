                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users_orders";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Pedidos Totais</p>
                                </div>
                            </div>
                        </div>
                    </div>	                   
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from res_category";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Categ. de restaurantes</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users_orders WHERE status = 'in process' ";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Pedidos no processo</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users_orders WHERE status = 'closed' ";
												$result=mysqli_query($db,$sql); 
													...
													echo $rws;?></h2>
                                    <p class="m-b-0">Pedidos entregues</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php 
                                        ...
                                        echo $sum;
                                        ?></h2>
                                    <p class="m-b-0">Total de ganhos</p>
                                </div>
                            </div>
                        </div>
                    </div>
