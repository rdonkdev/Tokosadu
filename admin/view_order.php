...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Restaurante</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_restaurant.php">Todos Restaurantes</a></li>
								<li><a href="add_category.php">Add Categoria</a></li>
                                <li><a href="add_restaurant.php">Add Restaurante</a></li>
        ...
        <div class="page-wrapper">
                                        ...
                                        <tbody>
                                           <?php
												...
												<td><strong>Título:</strong></td>
												    <td><center><?php echo $rows['title']; ?></center></td>
													   ...
													   <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
														<button type="button" class="btn btn-primary">Exibir detalhes do usuário</button></a>
											...
											<tr>
												    ...
												    <td><center>MZN<?php echo $rows['price']; ?></center></td>
											...
											<tr>
													...
													<?php 
																			...
																			{
																			?>
																			<td> <center><button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Despacho</button></center></td>
																		   <?php 
																			  }
            ...
            <footer class="footer"> © 2023 - Tocossado All Rights Reserved: <a href="instagram.com/stackdevz/" >StackDev</a> </footer>
