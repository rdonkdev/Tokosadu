        ...
        <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Entrega e Retirada de Pedidos</h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Escolha o Restaurante</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Pedir comida</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>Entrega ou retirada</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">A maneira mais fácil de pedir sua comida favorita entre esses 6 pratos principais</p>
                </div>
                <div class="row">
						<?php 					
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>Nós temos o que você precisa com menus de uma variedade de restaurantes de entrega online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>Nós temos o que você precisa com uma variedade de restaurantes de entrega online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Receba sua comida! E desfrute da sua refeição! </p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#"> <img src="images/mpesa.png" alt="M-Pesa" width="30px"> </a>
                                </li>
                                <li>
                                    <a href="#"> <img src="images/emola.png" alt="emola" width="33px"> </a>
                                </li>
                                <li>
                                    <a href="#"> <img src="images/ponto24.png" alt="ponto24" width="50px" > </a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Maputo, Liberdade</p>
                                    <h5>Phone: +258 87 562 1487</a></h5> </div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Addition informations</h5>
                           <p>Mais opções e mais sabor, alimentamos essa ideia 24 horas por dia.</p>
                        </div>
                    </div>
                </div>
